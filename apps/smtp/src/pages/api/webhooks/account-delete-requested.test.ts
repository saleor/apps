...
import { handler } from "./account-delete-requested";
...
const basePayload: AccountDeleteRequestedWebhookPayloadFragment = {
  user: {
    id: "VXNlcjox",
  ...
  redirectUrl: "https://example.com/delete",
  token: "delete-token",
...
describe("account-delete-requested handler", () => {
