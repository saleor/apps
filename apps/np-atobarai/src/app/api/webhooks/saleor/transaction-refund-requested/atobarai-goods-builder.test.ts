...
describe("AtobaraiGoodsBuilder", () => {
  let builder: AtobaraiGoodsBuilder;

  beforeEach(() => {
    builder = new AtobaraiGoodsBuilder();
  });

  describe("buildForNoFulfillmentPartialRefundWithoutLineItems", () => {
    it("should exclude discount line when amountAdjusted is 0", () => {
      const result = builder.buildForNoFulfillmentPartialRefundWithoutLineItems({
    ...
    it("should add discount line based on amountAdjusted", () => {
      const refundToApply = 300;
      const result = builder.buildForNoFulfillmentPartialRefundWithoutLineItems({
        sourceObject: mockedSourceObject,
        useSkuAsName: false,
        amountAdjusted: refundToApply,
      });
  ...
  describe("buildForNoFullfilmentPartialRefundWithLineItems", () => {
    ...
    it("should build goods with reduced quantities for refunded lines", () => {
      ...
      const result = builder.buildForNoFullfilmentPartialRefundWithLineItems({
