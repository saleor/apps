...
interface GetTypesenseConfigurationArgs {
  authData: AuthData;
}

const logger = createLogger("getTypesenseConfiguration");

export const getTypesenseConfiguration = async ({ authData }: GetTypesenseConfigurationArgs) => {
