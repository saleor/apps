...
import { ConnectionConfigRepo } from "@/modules/app-config/repositories/connection-config-repo";
import { connectionConfigRepoImpl } from "@/modules/app-config/repositories/connection-config-repo-impl";
...
export const createTrpcContextAppRouter = async ({ req }: FetchCreateContextFnOptions) => {
  return {
    ...
    configRepo: connectionConfigRepoImpl as ConnectionConfigRepo,
