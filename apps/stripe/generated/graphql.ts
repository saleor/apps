...
export type ConfigChannelFragment = { readonly id: string, readonly name: string, readonly slug: string, readonly isActive: boolean, readonly currencyCode: string };
...
type EventMetadata_CustomerDeleted_Fragment = { readonly version?: string | null, readonly recipient?: { readonly id: string } | null };
...
type EventMetadata_CustomerTypeCreated_Fragment = { readonly version?: string | null, readonly recipient?: { readonly id: string } | null };

type EventMetadata_CustomerTypeDeleted_Fragment = { readonly version?: string | null, readonly recipient?: { readonly id: string } | null };

type EventMetadata_CustomerTypeUpdated_Fragment = { readonly version?: string | null, readonly recipient?: { readonly id: string } | null };
...
export type FetchChannelsQuery = { readonly channels?: ReadonlyArray<{ readonly id: string, readonly name: string, readonly slug: string, readonly isActive: boolean, readonly currencyCode: string }> | null };
...
export const UntypedConfigChannelFragmentDoc = gql`
    fragment ConfigChannel on Channel {
  id
  name
  slug
  isActive
...
export const UntypedFetchChannelsDocument = gql`
  ...
  channels {
    ...
    ${UntypedConfigChannelFragmentDoc}`;
...
${UntypedEventMetadataFragmentDoc}
${UntypedChannelFragmentDoc}`;
export const ConfigChannelFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"ConfigChannel"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Channel"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"isActive"}},{"kind":"Field","name":{"kind":"Name","value":"currencyCode"}}]}}]} as unknown as DocumentNode<ConfigChannelFragment, unknown>;
