...
class AuthorizationActionRequired extends SuccessWebhookResponse {
  ...
  getResponse() {
    const typeSafeResponse = buildSyncWebhookResponsePayload<"TRANSACTION_INITIALIZE_SESSION">({
      data: AuthorizationActionRequired.ResponseDataSchema.parse({
        paymentIntent: {
          stripeClientSecret: this.stripeClientSecret,
        },
      }),
...
class AuthorizationFailure extends SuccessWebhookResponse {
  ...
  getResponse() {
    const typeSafeResponse = buildSyncWebhookResponsePayload<"TRANSACTION_INITIALIZE_SESSION">({
      ...
      message: this.error.merchantMessage,
      amount: this.saleorEventAmount,
      data: AuthorizationFailure.ResponseDataSchema.parse({
        paymentIntent: {
          errors: [
            {
              code: this.error.publicCode,
