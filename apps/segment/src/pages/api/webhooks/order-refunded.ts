...
import { type OrderRefundedSubscriptionPayloadFragment } from "@/generated/graphql";
...
const handler: NextJsWebhookHandler<OrderRefundedSubscriptionPayloadFragment> = async (
  req,
  res,
  context,
) => {
...
export default wrapWithLoggerContext(
  withSpanAttributes(orderRefundedAsyncWebhook.createHandler(handler)),
  loggerContext,
);
