...
const handler = createManifestHandler({
  async manifestFactory({ appBaseUrl }) {
    ...
    const manifest: AppManifest = {
      about:
        "Saleor Onboarding App — Store Readiness guide on the Dashboard home page. Walks new merchants through sales channel setup, first product, payments, and an optional test order. Optional tracks cover Customer Emails and connecting a Paper storefront. Builder tools (GraphiQL, custom app token, invite staff) stay secondary.",
