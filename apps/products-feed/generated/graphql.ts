...
export type AttributeWithMappingFragmentFragment = {
  __typename?: "Attribute";
  id: string;
  name?: string | null;
  slug?: string | null;
...
export type BasicProductDataFragment = {
  __typename?: "ProductVariant";
  id: string;
  name: string;
  sku?: string | null;
...
export type CategoryWithMappingFragmentFragment = {
  __typename?: "Category";
  id: string;
  name: string;
  ...
  parent?: {
    __typename?: "Category";
    name: string;
    parent?: { __typename?: "Category"; name: string } | null;
  } | null;
};

export type GoogleFeedProductVariantFragment = {
  __typename?: "ProductVariant";
  id: string;
  name: string;
  sku?: string | null;
  ...
  attributes: Array<{
    ...
    values: Array<{ __typename?: "AttributeValue"; value?: string | null; name?: string | null }>;
  }>;
  product: {
    __typename?: "Product";
    id: string;
    ...
    productType: { __typename?: "ProductType"; isShippingRequired: boolean };
    media?: Array<{
      __typename?: "ProductMedia";
      id: string;
      alt: string;
...
export type UpdateCategoryMappingMutation = {
  __typename?: "Mutation";
  updateMetadata?: {
    __typename?: "UpdateMetadata";
    errors: Array<{ __typename?: "MetadataError"; message?: string | null }>;
  } | null;
};
...
export type FetchAttributesWithMappingQuery = {
  __typename?: "Query";
  attributes?: {
    __typename?: "AttributeCountableConnection";
    ...
    edges: Array<{
      __typename?: "AttributeCountableEdge";
      node: { __typename?: "Attribute"; id: string; name?: string | null; slug?: string | null };
    }>;
  } | null;
};

export type FetchBasicProductDataQueryVariables = Exact<{
  first: Scalars["Int"]["input"];
  after?: InputMaybe<Scalars["String"]["input"]>;
  channel: Scalars["String"]["input"];
}>;

export type FetchBasicProductDataQuery = {
  __typename?: "Query";
  productVariants?: {
    __typename?: "ProductVariantCountableConnection";
    pageInfo: { __typename?: "PageInfo"; hasNextPage: boolean; endCursor?: string | null };
...
export type FetchProductAttributesDataQueryVariables = Exact<{
  first: Scalars["Int"]["input"];
  after?: InputMaybe<Scalars["String"]["input"]>;
  channel: Scalars["String"]["input"];
}>;

export type FetchProductAttributesDataQuery = {
  __typename?: "Query";
  productVariants?: {
    __typename?: "ProductVariantCountableConnection";
    pageInfo: { __typename?: "PageInfo"; hasNextPage: boolean; endCursor?: string | null };
...
export type FetchProductCursorsQuery = {
  __typename?: "Query";
  productVariants?: {
    __typename?: "ProductVariantCountableConnection";
    pageInfo: {
...
export type FetchChannelsQuery = {
  __typename?: "Query";
  channels?: Array<{ __typename?: "Channel"; name: string; id: string; slug: string }> | null;
};
...
`;
export const AttributeWithMappingFragmentFragmentDoc = {
  kind: "Document",
  definitions: [
    {
...
} as unknown as DocumentNode<AttributeWithMappingFragmentFragment, unknown>;
export const BasicProductDataFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "BasicProductData" },
...
} as unknown as DocumentNode<BasicProductDataFragment, unknown>;
export const CategoryWithMappingFragmentFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "CategoryWithMappingFragment" },
      ...
      selectionSet: {
        ...
        selections: [
          ...
          {
            kind: "Field",
            alias: { kind: "Name", value: "googleCategoryId" },
            name: { kind: "Name", value: "metafield" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "key" },
                value: { kind: "StringValue", value: "google_category_id", block: false },
              },
            ],
          },
        ],
...
} as unknown as DocumentNode<CategoryWithMappingFragmentFragment, unknown>;
export const GoogleFeedProductVariantFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "GoogleFeedProductVariant" },
      typeCondition: { kind: "NamedType", name: { kind: "Name", value: "ProductVariant" } },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "seoDescription" } },
                {
                  ...
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "isShippingRequired" } },
                    ],
                  },
                },
                {
                        ...
                        arguments: [
                          {
                            ...
                            value: { kind: "Variable", name: { kind: "Name", value: "imageSize" } },
                          },
                        ],
                      },
...
} as unknown as DocumentNode<GoogleFeedProductVariantFragment, unknown>;
export const ProductAttributesFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
...
} as unknown as DocumentNode<ProductAttributesFragment, unknown>;
export const RelatedProductsFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      ...
      selectionSet: {
        ...
        selections: [
          ...
          { kind: "Field", name: { kind: "Name", value: "seoDescription" } },
          {
            ...
            selectionSet: {
              kind: "SelectionSet",
              selections: [{ kind: "Field", name: { kind: "Name", value: "isShippingRequired" } }],
            },
          },
          {
            kind: "Field",
...
} as unknown as DocumentNode<RelatedProductsFragment, unknown>;
...
export const UpdateCategoryMappingDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "UpdateCategoryMapping" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
        ...
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "googleCategoryId" } },
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "String" } },
          },
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "updateMetadata" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "id" },
                ...
                value: {
                  ...
                  fields: [
                    ...
                    },
                    {
                      ...
                      value: {
                        kind: "Variable",
                        name: { kind: "Name", value: "googleCategoryId" },
                      },
                    },
                  ],
                },
...
} as unknown as DocumentNode<UpdateCategoryMappingMutation, UpdateCategoryMappingMutationVariables>;
...
export const FetchAttributesWithMappingDocument = {
  ...
  FetchAttributesWithMappingQuery,
  FetchAttributesWithMappingQueryVariables
>;
export const FetchBasicProductDataDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "FetchBasicProductData" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
...
} as unknown as DocumentNode<FetchBasicProductDataQuery, FetchBasicProductDataQueryVariables>;
export const FetchCategoriesWithMappingDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
  ...
  FetchCategoriesWithMappingQuery,
  FetchCategoriesWithMappingQueryVariables
>;
export const FetchProductAttributesDataDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "FetchProductAttributesData" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "first" } },
  ...
  FetchProductAttributesDataQuery,
  FetchProductAttributesDataQueryVariables
>;
export const FetchProductCursorsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "FetchProductCursors" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "first" } },
...
} as unknown as DocumentNode<FetchProductCursorsQuery, FetchProductCursorsQueryVariables>;
export const FetchRelatedProductsDataDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "FetchRelatedProductsData" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
        ...
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "imageSize" } },
          type: { kind: "NamedType", name: { kind: "Name", value: "Int" } },
          defaultValue: { kind: "IntValue", value: "1024" },
        },
      ],
      selectionSet: {
        kind: "SelectionSet",
...
} as unknown as DocumentNode<FetchRelatedProductsDataQuery, FetchRelatedProductsDataQueryVariables>;
export const ShopDetailsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
...
export const FetchChannelsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "FetchChannels" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            ...
            selectionSet: {
              kind: "SelectionSet",
              selections: [{ kind: "FragmentSpread", name: { kind: "Name", value: "Channel" } }],
            },
          },
        ],
      },
...
} as unknown as DocumentNode<FetchChannelsQuery, FetchChannelsQueryVariables>;
