...
export type GetAppDetailsAndWebhooksDataQuery = { __typename?: 'Query', app?: { __typename?: 'App', id: string, appUrl?: string | null, name?: string | null, webhooks?: Array<{ __typename?: 'Webhook', id: string, isActive: boolean, name: string, targetUrl: string, subscriptionQuery?: string | null, syncEvents: Array<{ __typename?: 'WebhookEventSync', name: string, eventType: WebhookEventTypeSyncEnum }>, asyncEvents: Array<{ __typename?: 'WebhookEventAsync', name: string, eventType: WebhookEventTypeAsyncEnum }> }> | null } | null };
