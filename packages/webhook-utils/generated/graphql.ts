...
export type AppDetailsFragment = { __typename?: 'App', id: string, appUrl?: string | null, name?: string | null, webhooks?: Array<{ __typename?: 'Webhook', id: string, isActive: boolean, name: string, targetUrl: string, subscriptionQuery?: string | null, syncEvents: Array<{ __typename?: 'WebhookEventSync', name: string, eventType: WebhookEventTypeSyncEnum }>, asyncEvents: Array<{ __typename?: 'WebhookEventAsync', name: string, eventType: WebhookEventTypeAsyncEnum }> }> | null, metadata: Array<{ __typename?: 'MetadataItem', key: string, value: string }>, privateMetadata: Array<{ __typename?: 'MetadataItem', key: string, value: string }> };

export type ChannelDetailsFragment = { __typename?: 'Channel', id: string, slug: string, name: string, currencyCode: string };

export type ShopDetailsFragment = { __typename?: 'Shop', version: string, domain: { __typename?: 'Domain', url: string } };

export type WebhookDetailsFragment = { __typename?: 'Webhook', id: string, isActive: boolean, name: string, targetUrl: string, subscriptionQuery?: string | null, syncEvents: Array<{ __typename?: 'WebhookEventSync', name: string, eventType: WebhookEventTypeSyncEnum }>, asyncEvents: Array<{ __typename?: 'WebhookEventAsync', name: string, eventType: WebhookEventTypeAsyncEnum }> };
